...
import AdminSuspenseWrapper from "./AdminSuspenseWrapper";
...
export default function AdminLayout({ children }) {
  ...
  useEffect(() => {
    ...
    return () => document.removeEventListener("mousedown", handleClickOutsideEvent);
  }, []);

  return (
    <AdminSuspenseWrapper>
      <div
        className="flex min-h-screen bg-[#eff3f4] overflow-hidden overflow-y-hidden"
