...
export default function CleaningServicesAdminPage() {
    ...
    const load = async () => {
      try {
        ...
        const category = (cats || []).find((c) => {
          ...
          return name.includes("clean") || name.includes("cleaning");
        });
        ...
        const filtered = (allServices || []).filter((svc) => {
          ...
          return (subId && subIds.has(subId)) || catName.includes("clean") || catName.includes("cleaning");
        });
    ...
    <div className="min-h-screen bg-[#f8fafc] p-4">
      <div className="bg-white rounded-xl shadow p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Cleaning — Services Management</h1>
            <p className="text-sm text-gray-500 mt-1">Manage Cleaning services and packages</p>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {services.length === 0 ? (
                    <tr>
                      <td colSpan={8} className="px-3 py-6 text-center text-gray-500">No services found for Cleaning.</td>
                    </tr>
                  ) : (
                    services
                      .filter((s) => {
